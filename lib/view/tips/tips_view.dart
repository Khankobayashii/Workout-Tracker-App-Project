...
import 'package:workout_fitness/common_widget/tips_row.dart';
...
class _TipsViewState extends State<TipsView> {
  List tipsArr = [
    ...
    {"name": "Water and Food"},
    {"name": "Drink water"},
    {"name": "How many time a day to eat"},
    ...
    return Scaffold(
      ...
      body: ListView.separated(
          ...
          itemBuilder: (context, index) {
            var t0bj = tipsArr[index] as Map? ?? {};
            return TipsRow(
              t0bj: t0bj,
              isActive: index == 0,
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (ontext)=> TipsDetailView(t0bj: t0bj)));
              },
            );
          },
